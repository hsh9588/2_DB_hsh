...
-- * CURRVAL 주의사항 *
--> CURRVAL 마지막 NEXTVAL 호출 값을 다시 보여주는 기능
...
AS SELECT EMP_ID, EMP_NAME FROM EMPLOYEE E;
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '둘리');
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '또치');
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '핑핑이');
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '스폰지밥');
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL, '뚱이');
