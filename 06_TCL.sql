...
ROLLBACK; -- 트랜젝션만 되돌린다. (COMMIT 후 롤백 안됨)

SELECT * FROM DEPARTMENT2 D;

DELETE FROM DEPARTMENT2 D 
...
SELECT * FROM DEPARTMENT2 D; -- 개발6팀만 롤백

-- SP1 지점까지 롤백
ROLLBACK TO SP1;
SELECT * FROM DEPARTMENT2 D; -- 개발5팀만 롤백

-- 롤백 수행
ROLLBACK;
SELECT * FROM DEPARTMENT2 D; -- 개발4팀 롤백
