...
ALTER TABLE DEPT_COPY ADD CONSTRAINT DEP_DEPT_TITLE UNIQUE(DEPT_TITLE);

-- DEPT_COPY의 DEPT_TITLE 컬럼에 UNIQUE 삭제

ALTER TABLE DEPT_COPY DROP CONSTRAINT DEP_DEPT_TITLE;

-- *** DEPT_CODE의 DEPT_TITLE 컬럼에 NOT NULL 제약조건 추가/삭제 ***

ALTER TABLE DEPT_COPY ADD CONSTRAINT DEPT_COPY_TITLE_NN NOT NULL(DEPT_TITLE);
--> NOT NULL 제약조건은 새로운 조건을 추가하는 것이 아닌
-- 컬럼 자체에 NULL 혀용/비허용을 제어하는 성질 변경의 형태로 인식됨.

-- MODIFY(수정하다) 구문을 사용해서 NULL 제어
ALTER TABLE DEPT_COPY 
MODIFY DEPT_TITLE NOT NULL; -- DEPT_TITLE 컬럼을 NOT NULL

ALTER TABLE DEPT_COPY 
MODIFY DEPT_TITLE NULL; -- DEPT_TITLE 컬럼을 NULL
...
-- ERROR : ORA-12899: "KH_HSH"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
--> DEPT_COPY 테이블에 PK 추가(D_COPY_PK)
...
INSERT INTO TB2 VALUES(14, 4); -- 오류
