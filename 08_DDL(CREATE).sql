...
-- 문자인코딩 UTF-8 : 영어, 숫자는 1BYTE, 한글, 특수문자 등은 3BYTE 취급 
...
INSERT INTO MEMBER VALUES('MEM02', '123477', '아무개', '920307-1231234', SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO MEMBER VALUES('MEM03', 'A1234', '김개똥', '921115-2342345', DEFAULT);

-- 가입일 -> INSERT 시 미작성 하는 경우 -> DEAFULT 값이 반영됨
--INSERT INTO 테이블명(컬럼명1, 컬럼명2, 컬럼명3)
--VALUES(값1, 값2, 값3)
INSERT INTO MEMBER(MEMBER_ID, MEMBER_PWD, MEMBER_NAME)
VALUES('MEM04', 'A123477', '이소똥');

-- ** JDBC에서 날짜를 입력 받았을 때 삽입하는 방법 **
-- '2022-09-13 17:33:27'
INSERT INTO MEMBER VALUES('MEM05', 'PASS05', '김길똥', '930303-1333444',
...
INSERT INTO MEMBER2 VALUES('MEM01', 'PASS01', '고길동', 7712365752);
INSERT INTO MEMBER2 VALUES('MEM02', 'PASS02', '고둘리', 01045677890);
...
--    USER_ID VARCHAR2(20) CONSTRAINT USER_ID_U UNIQUE,
    ...
    EMAIL VARCHAR2(50),
    /* 테이블 레벨 */
    CONSTRAINT USER_ID_U UNIQUE(USER_ID) -- 테이블 레벨(제약조건 미지정)
);
...
-- ORA-00001: 무결성 제약 조건(KH_HSH.USER_ID_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_HSH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_HSH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
--> 서브쿼리로 테이블 생성 시
-- 테이블의 형태(컬럼명, 데이터 타입) + NOT NULL 제약조건이 
...
ALTER TABLE DEPARTMENT ADD CONSTRAINT EMP_LOCATEION_ID
